...
c        Check ionospheric profile flag
c        0 ---- non-exponential profile on whole path
c        1 ----     exponential profile on whole path
c        2 ----     exponential profiles - all day
c        3 ----     exponential profiles - all night
c        4,11--     exponential profiles - specific date & time

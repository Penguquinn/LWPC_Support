...
c     Corners of op area
      ...
      rlng=alng
      if(rlng .ge. xlng1) rlng=rlng-REAL(twopi)
...
c        Northern strip op area
         ...
         do while (rclt .gt. xclt1 .and. rho .gt. 0.)
            ...
            range=rho
            rho=rho-2000.
            call RECVR2 (tlng,tclt,ctclt,stclt,xtr,rho/REAL(r_earth),
...
c           Southern strip op area
            ...
            do while (rclt .lt. xclt2 .and. rho .gt. 0.)
               ...
               range=rho
               rho=rho-2000.
               call RECVR2 (tlng,tclt,ctclt,stclt,xtr,
     &                      rho/REAL(r_earth),rlng,rclt,crclt,srclt)
            end do
            rclt=xclt
            rho=range
...
c           Op area is not a strip
     ...
     &                      rho/REAL(r_earth),rlng,rclt,crclt,srclt)
               ...
               if (rclt .lt. xclt1 .and. rclt .gt. xclt2) then
                  if (rlng .gt. xlng1) rlng=rlng-REAL(twopi)

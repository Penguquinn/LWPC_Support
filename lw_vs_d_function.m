...
% log_file = '100n08s12_NAA-EG.log';
% log_file = 'vic_amb_3_naa_eg.log';
% log_file = 'vic_amb_3_multi_est_naa_eg.log';
% log_file = '750b32_NAA-EG.log';
...
% figure; plot(rho_full,20*log10(abs(s0)))
% hold on; plot(rho_full,20*log10(abs(s1)))
% hold on; plot(rho_full,20*log10(abs(s2)))
% hold on; plot(rho_full,20*log10(abs(s3)))

...
c  Change History:
c     23 Oct 1990   Modified to check the parameters of the map and
...
c     06 Jul 1994   Added orthographic projection.

c     28 Sep 1995   Modified for use with the new geophysics routines.

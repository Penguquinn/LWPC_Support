...
c     Transfer data into appropriate return slots
      ...
      if (print_hdr .gt. 0) then
         print *,'[READ_C_GRD.FOR] Printing out Header information'
...
cxx         write(lwpcLOG_lun,
     ...
     &         ''case_id:  '',a/
     &         ''prfl_id:  '',a)')
     &           file_id(1)(:MAX(1,ISTR_LENGTH(file_id(1)))),
     &           file_id(2)(:MAX(1,ISTR_LENGTH(file_id(2)))),
     &           file_id(3)(:MAX(1,ISTR_LENGTH(file_id(3)))),
     &           prgm_id,
     &           case_id   (:MAX(1,ISTR_LENGTH(case_id))),
     &           prfl_id

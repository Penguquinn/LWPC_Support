...
c     LWPC parameters
     ...
     &      /mf_rntg/
     &              r(4),dr(4),drdc(4),drdcdh(4),roe(8),rnd(5)
     &      /mf_rseq/
...
c     Test of whether height of minimum in vlaue of truncation error
c     has been found.
...
86    irefht=1
      ...
      write(lwpcLOG_lun,
     &    '(''MF_INITLG: '',
     &      ''WARNING:  Reflection ht set to HTNTRP='',f7.2,1x,
     &      ''for interpolation'')')
     &        ht0
      go to 31
...
88    notlin=0
     ...
     &           etol,notlin
      ...
      if (lprnt .ne. 0)
     &   write(lwpcLOG_lun,
     &       '(''MF_INITLG: At theta='',2f7.2,1x,
     &         ''the reflection ht='',f7.2)')
     &           theta0,ht0

...
c  Change History:
c     10 Nov 1993   Do the restart of MF using IEXACT=1.

c     30 Jun 1994   Drop END_FILE from argument list.

c     14 Nov 1994   Added subroutine MF_GET_MC to calculate mode
c                   constants when SW fails at the starting segment.

c     13 Dec 1994   Added specification for PRFL_FILE.

c     26 Sep 1995   Changed all PRINTs to WRITE(6)s.

c     21 Oct 1995   Changed to get the LOG unit from LWPC_LUN.CMN.

c     08 Feb 1999   When we want to continue using the original

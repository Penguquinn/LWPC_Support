...
c     Note:  CAPI and NORM are used differently here than in LW_FAST_MC,
c     but it's OK because the parameters are not passed between this
c     routine and LW_FAST_MC.

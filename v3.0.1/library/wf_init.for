...
c     Local
     ...
     &      -t14*(t31*t42-t32*t41)
         ...
         if (l .ne. 2) then
            m=1
            do while (m .le. 4)
               angq=ATAN2(DIMAG(q(m)),DREAL(q(m)))*180.d0/pi
         ...
         q1 test=DBLE(q(1)+(0.d0,1.d0)*q(1))
         q4 test=DBLE(q(4)+(0.d0,1.d0)*q(4))
         if (q4 test .gt. q1 test) q(1)=q(4)
         q2 test=DBLE(q(2)+(0.d0,1.d0)*q(2))
         q3 test=DBLE(q(3)+(0.d0,1.d0)*q(3))
